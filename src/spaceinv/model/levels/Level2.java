...
public class Level2 implements ILevel {
    ...
    private final List<AbstractSpaceShip> ships =
            addAll(
                    ...
                    distribute(asList(new Frigate(80,startPos+120), 10), 10),
                    distribute(asList(new BattleCruiser(80,startPos+160), 10), 10),
                    distribute(asList(new Bomber(80,startPos+200), 10), 10),
                    distribute(asList(new Bomber(80,startPos+240), 10), 10),
                    distribute(asList(new BattleCruiser(80,startPos+280), 10), 10),
                    distribute(asList(new Frigate(80,startPos+320), 10), 10)
            );
